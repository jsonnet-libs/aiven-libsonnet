---
permalink: /0.8.0/aiven/v1alpha1/kafkaTopic/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.config`](#obj-specconfig)
    ...
    * [`fn withMin_cleanable_dirty_ratio(min_cleanable_dirty_ratio)`](#fn-specconfigwithmin_cleanable_dirty_ratio)
...
### fn spec.config.withMin_cleanable_dirty_ratio

```ts
withMin_cleanable_dirty_ratio(min_cleanable_dirty_ratio)
```
